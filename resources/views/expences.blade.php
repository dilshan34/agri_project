...
<div class="row pt-3">
<div class="col-sm-5">
<form action="/expence" method="post" class="mb-5">
 @csrf 
 <div class="form-group">
    ...
    <input name="description" type="text" class="form-control" placeholder="Source of expence"> 
    ...
    <input name="amount" type="text" class="form-control" placeholder="Outflowed amount(Rs)"> 
