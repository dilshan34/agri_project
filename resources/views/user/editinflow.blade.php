...
<form action="/outflow" method="post" class="mb-5">
 @csrf 
 <div class="form-group">
    <label>Category*</label> <span class="font-weight-bold text-danger" style="font-family:revert; font-size:77%">@error('crop_id'){{$message}}@enderror</span><select name="crop_name" class="form-control">
