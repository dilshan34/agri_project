...
class Home extends Controller
{
  function FormEmployee(){
      ...
      ->get();
      return view('welcome',['crops'=>$data,'data'=>$data2]);
  }
...
function EditEmployee($id){
    ...
    $data = employee::orderby('id','desc')->get();
    return view('editEmployee',['employee' =>$data2,'employees' =>$data,'success'=>$success]);
}
...
function CropsInfo(){
    ...
    return view('crops',['crops'=>$data,'inflows'=>$data2,'outflows'=>$data3]);
}
...
function Editinflow($id){
    ...
    $data2 = harvest_inflow::where('created_at',$date)->orderby('id','desc')->get();
    $data3 = harvest_outflow::where('created_at',$date)->orderby('id','desc')->get();
    return view('editinflow',['inflow'=>$data4,'crops'=>$data,'inflows'=>$data2,'outflows'=>$data3]);
}
...
function EditOutflow($id){
    ...
    $data2 = harvest_inflow::where('created_at',$date)->orderby('id','desc')->get();
    $data3 = harvest_outflow::where('created_at',$date)->orderby('id','desc')->get();
    return view('editoutflow',['outflow'=>$data4,'crops'=>$data,'inflows'=>$data2,'outflows'=>$data3]);
}
...
function CropsIncome(){
    ...
    return view('income',['crops'=>$data,'incomes'=>$data2]);
}

function CropsExpence(){
    $data = crop::get();
    $data2 = expence::where('created_at',Carbon::today())->get();
    return view('expences',['crops'=>$data,'expences'=>$data2]);
}
...
function EditIncome($id){
    ...
    return view('editincome',['income'=>$data3,'crops'=>$data,'incomes'=>$data2]);
}
...
function EditExpence($id){
    ...
    return view('editexpence',['expence'=>$data3,'crops'=>$data,'expences'=>$data2]);
}
